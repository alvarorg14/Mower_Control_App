...
// in mower_control_app/test/widgets/employee_card_test.dart.
...
import 'package:mower_control_app/api/employees.dart' as _i7;
import 'package:mower_control_app/api/mowers.dart' as _i4;
import 'package:mower_control_app/models/auth.dart' as _i6;
import 'package:mower_control_app/models/employee.dart' as _i3;
...
/// A class which mocks [EmployeesApi].
///
/// See the documentation for Mockito's code generation for more information.
class MockEmployeesApi extends _i1.Mock implements _i7.EmployeesApi {
  MockEmployeesApi() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Future<List<_i3.Employee>> fetchEmployeesForCompany(_i6.Auth? auth) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i5.Future<_i3.Employee> createEmployee(
    _i6.Auth? auth,
    String? name,
    String? surname1,
    String? surname2,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i5.Future<_i3.Employee>.value(_FakeEmployee_1(
          this,
          Invocation.method(
            #createEmployee,
            [
  ...
  @override
  _i5.Future<void> deleteEmployee(
    _i6.Auth? auth,
    String? employeeId,
  ) =>
      (super.noSuchMethod(
